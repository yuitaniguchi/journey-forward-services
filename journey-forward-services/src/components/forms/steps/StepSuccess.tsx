...
export default function StepSuccess({ requestNumber }: Props) {
  return (
    <div className="flex flex-col items-center justify-center py-8 text-center animate-in fade-in zoom-in-95 duration-500">
      {/* 修正ポイント: 
         bg-[#3F7253] (単色) を削除し、
         bg-gradient-to-br from-[#367D5E] to-[#53C090] (グラデーション) に変更しました。
      */}
      <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#367D5E] to-[#53C090] shadow-md">
      ...
      <Button
        ...
        className="min-w-[180px] rounded-md bg-[#3F7253] px-6 py-2 text-white hover:bg-[#2e563d] transition-all shadow-sm"
      >
        Go to Main Page
      </Button>
    </div>
